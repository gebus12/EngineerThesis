...
namespace EngineerCodeFirst.Controllers
{
    public class BusesController : Controller
    {
        ...
        */
        ...
        public ActionResult Create([Bind(Include = "BusID,RegNum,Status,Latitude,Longitude,Accessible")] Bus bus, string[] selectedDrivers, string[] selectedLines)
        {
        ...
        public ActionResult Edit(int? id, string[] selectedDrivers, string[] selectedLines)
        {
            ...
            if (TryUpdateModel(busToUpdate, "",
               new string[] { "BusID","RegNum","Status","Latitude","Longitude","Accessible" }))
            {
                try
                {
